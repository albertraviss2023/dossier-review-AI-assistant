...
- Report ID: `robustness_simulation_20260417_211815`
- Executed At (UTC): `2026-04-17T21:19:34.253091`
- Passed: `6` / `10`
- Failed: `4`
...
- Route: `chat_only`
- Citations: `0`
- Notes: Expected a natural greeting response rather than dossier-heavy content.; Scenario failed its robustness expectation.
- Response excerpt:

```text
I can help with general reviewer questions, dossier review tasks, policy guidance, AMR stewardship analysis, and report preparation. If you want a dossier-specific answer, select or provide the active dossier first.
```

### S2 - typo_issue_discovery
- Prompt: `identfy key isues and contrdictions in this dossir`
- Dossier: `SIM-WATCH-20260417_211815`
- Passed: `True`
...
- Dossier: `SIM-STANDARD-20260417_211815`
- Passed: `False`
- Recommendation: `approval_granted`
- Route: `fallback`
- Citations: `2`
- Notes: Expected stability-oriented retrieval despite typos.; Scenario failed its robustness expectation.
- Response excerpt:
...
- Dossier: `SIM-SCANNED-20260417_211815`
- Passed: `True`
- Recommendation: `additional_information_required`
- Route: `fallback`
- Citations: `2`
...
- Route: `fallback`
- Citations: `0`
- Notes: Expected routed guidance response using the unified assistant path.; Scenario failed its robustness expectation.
- Response excerpt:
...
- Route: `fallback`
- Citations: `2`
- Notes: Expected reasoning trace, final recommendation, and citations in the end-to-end pipeline.; Scenario failed its robustness expectation.
- Response excerpt:
...
- Dossier: `SIM-SCANNED-20260417_211815`
- HTML: `/v1/reports/report-3742cafad326/html`
- TXT: `/v1/reports/report-3742cafad326/text`
- JSON: `/v1/reports/report-3742cafad326/json`
